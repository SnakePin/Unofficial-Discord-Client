...
if(WIN32)
	...
	if(MINGW)
		...
		if (EXISTS "${SDL2_ROOT}/libs/${SDL2_LIB_PATH_PREFIX}/libSDL2.a")
			set(SDL2_LIBS "${SDL2_ROOT}/libs/${SDL2_LIB_PATH_PREFIX}/libSDL2.a")
			set(SDL2_DLLS "${SDL2_ROOT}/libs/${SDL2_LIB_PATH_PREFIX}/libSDL2.dll.a")
			if(_SDL2_use_main)
