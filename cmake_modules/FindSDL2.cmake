...
if(WIN32)
	...
	if(MINGW)
		set(SDL2_COMPILER_SPECIFIC_ROOT "${SDL2_ROOT}/mingw")
		if (EXISTS "${SDL2_COMPILER_SPECIFIC_ROOT}/libs/${SDL2_LIB_PATH_PREFIX}/libSDL2.dll.a")
			set(SDL2_LIBS "${SDL2_COMPILER_SPECIFIC_ROOT}/libs/${SDL2_LIB_PATH_PREFIX}/libSDL2.dll.a")
			set(SDL2_DLLS "${SDL2_ROOT}/msvc/libs/${SDL2_LIB_PATH_PREFIX}/SDL2.dll")
			if(_SDL2_use_main)
				list(APPEND SDL2_LIBS "${SDL2_COMPILER_SPECIFIC_ROOT}/libs/${SDL2_LIB_PATH_PREFIX}/libSDL2main.a")
			endif()
		endif()
	else()
	...
	set(SDL2_INCLUDE_DIRS "${SDL2_COMPILER_SPECIFIC_ROOT}/include")
